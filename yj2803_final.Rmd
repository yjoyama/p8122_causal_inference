...
Given SMD >0.1, all the selected covariates are imbalanced between the two smoking groups, indicating that adjustment of these covariates are required in the later analysis to estimate smoking's causal effect on gestational age.   
...
We cannot evaluate SUTVA due to the lack of information on how `smoker` was determined. 
